<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Keputusan_Permohonan_User.aspx.cs" Inherits="eSouvenir.Sou_Keputusan_Permohonan_User" %>
...
<body>
    <%--sidebar editor--%>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display: none; background-color: #a90505; color: #fff; width: 250px; background-image: url('./Images_Black/Default_A_wall_paper_consist_of_collages_of_stationary_items_1(1).jpg'); background-size: cover; background-repeat: no-repeat;" id="mySidebar">
        <button class="w3-bar-item w3-button w3-large" onclick="w3_close()">&times;</button>
<%--        <img src="path_to_your_image.jpg" alt="" style="width: 100%; max-height: 200px;" />--%>
        <a href="Sou_Senarai_Item_User.aspx" class="w3-bar-item w3-button">1. Request Stationary </a>
        ...
        <div class="w3-teal">
            ...
            <div style="background-color: #696969;">
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <h1>2. Order Status&nbsp;
                            <img src="./Images/settle.png" width="50" height="50" /></h1>
                    </div>
                </div>
            </div>
        </div>
