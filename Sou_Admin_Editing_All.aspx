<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Admin_Editing_All.aspx.cs" Inherits="eSouvenir.Sou_Admin_Editing_All" %>
            ...
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-5">                  
                        ...
                        <div class="form-group">
                            <label for="lblStokMinima"><b><span style="color: deepskyblue;" />6. Min Stock</b>  </label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="chkListOptions"><b><span style="color: deepskyblue;" />7. Package</b>  </label>
                        ...
                        <br />
                        <label for="lblStokMinima"><b><span style="color: deepskyblue;" />8. Image (Please DELETE first before Add image  </b></label>
                        ...
                        <div class="text-right">
                            ...
                            <asp:TextBox ID="txtIdItem" runat="server" ReadOnly="true" CssClass="form-control" Visible="false" Width="400px" Style="border-color: black; border-width: 1px;"></asp:TextBox>
                            <asp:TextBox ID="txtJumlahStock" CssClass="form-control" Visible="false" Width="400px" placeholder="Please insert the amount" runat="server" Style="border-color: black; border-width: 1px;"></asp:TextBox>
