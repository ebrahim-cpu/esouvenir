<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Admin_Editing_All_20240206b.aspx.cs" Inherits="eSouvenir.Sou_Admin_Editing_All" %>
...
<head runat="server">
    ...
    <style>
        body {
            background-image: url('Images/grey10.jpg');
            ...
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <br />
                        <div class="form-group">
                            <label for="lblKategori"><b>2. Category</b> </label>
                            <div class="a">
                        ...
                        <br />
                        <div class="form-group">
                            <label for="lblIdItem"><b>4.  Id Item </b></label>
                    ...
                    <div class="col-5">
                        ...
                        <br />
                        <div class="form-group">
                            <label for="lblStokMinima"><b>8. Min Stock</b>  </label>
                        ...
                        <br />
                        <div class="form-group">
                                <label for="txtStokMinima"><b>9. Package</b>  </label>
                            ...
                            <br />  
                        <label for="lblStokMinima"><b>9. Image (Please DELETE first before Add image  </b></label>
