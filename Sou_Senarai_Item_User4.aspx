<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Senarai_Item_User4.aspx.cs" Inherits="eSouvenir.Sou_Senarai_Item_User4" %>
            ...
            <form id="form1" runat="server">
                <div>
                    ...
                    <asp:DropDownList ID="ddlFilter" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlFilter_SelectedIndexChanged">
                        ...
                        <asp:ListItem Text=" Investor" Value="IsInvestor"></asp:ListItem>
                        <asp:ListItem Text=" Visitor" Value="IsVisitor"></asp:ListItem>
                        <asp:ListItem Text=" Student" Value="IsStudent"></asp:ListItem>
                        <asp:ListItem Text=" StaffRetired" Value="IsStaffRetired"></asp:ListItem>
                        <asp:ListItem Text=" StaffNoticed" Value="IsStaffNoticed"></asp:ListItem>
                        <asp:ListItem Text=" VIP" Value="IsVIP"></asp:ListItem>
                    </asp:DropDownList>
                    <br />
                    <br />
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_Item,Id_Kategori" DataSourceID="SqlDataSource1" CssClass="table table-3d table-striped table-bordered" AllowSorting="True" PageSize="300" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
                        <Columns>
