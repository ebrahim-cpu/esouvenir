<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_LogOut.aspx.cs" Inherits="eSouvenir.Sou_LogOut" %>
...
<body translate="no">
    <form id="loginform" class="login" role="form" runat="server">
        ...
        <b>Apps eSouvenir KTPC</b><br />
        <br />
        <div class="input-group-prepend">
            You have logout.<br />
            Thank You.
            <br />
            <a href="Sou_Login.aspx">Return To App.</a>
        </div>
        <br />
    </form>
</body>
