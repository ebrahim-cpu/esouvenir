<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Kelulusan_Souvenir_20240216.aspx.cs" Inherits="eSouvenir.Sou_Kelulusan_Souvenir" %>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <div class="btn-container">
                                                <asp:Button ID="AcceptButton" runat="server" Text="Accept" CssClass="btn btn-primary"
                                                    CommandName="AcceptCommand" CommandArgument='<%# Eval("Id") %>' OnClick="AcceptButton_Click"
                                                    Visible='<%# ShowAcceptButton(Eval("Status")) %>' />
                                                <asp:Button ID="RejectButton" runat="server" Text="Reject" CssClass="btn btn-danger ml-2"
                                                    CommandName="RejectCommand" CommandArgument='<%# Eval("Id") %>' OnClick="RejectButton_Click"
                                                    Visible='<%# ShowRejectButton(Eval("Status")) %>' />
                                                <asp:Button ID="UpdateButton" runat="server" Text="Update" CssClass="btn btn-warning"
