<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Senarai_Item_User4_20240215.aspx.cs" Inherits="eSouvenir.Sou_Senarai_Item_User4" %>
...
<head runat="server">
    ...
    <script>
        ...
        function searchGridView2() {
            ...
            document.getElementById("totalCountLabel").innerHTML = "Total Records: " + totalCount;
            document.getElementById("filteredCountLabel").innerHTML = "Filtered Records: " + filteredCount;
        }
    </script>
    <script>
            ...
            <form id="form1" runat="server">
                <div>
                    <asp:DropDownList ID="ddlFilter" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlFilter_SelectedIndexChanged">
                        ...
                        <asp:ListItem Text="IsInvestor" Value="IsInvestor"></asp:ListItem>
                        <asp:ListItem Text="IsVisitor" Value="IsVisitor"></asp:ListItem>
                        <asp:ListItem Text="IsStudent" Value="IsStudent"></asp:ListItem>
                        <asp:ListItem Text="IsStaffRetired" Value="IsStaffRetired"></asp:ListItem>
                        <asp:ListItem Text="IsStaffNoticed" Value="IsStaffNoticed"></asp:ListItem>
                        <asp:ListItem Text="IsVIP" Value="IsVIP"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_Item,Id_Kategori" DataSourceID="SqlDataSource1">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Nama_Item" HeaderText="Item Name" SortExpression="Nama_Item" />
                            <asp:BoundField DataField="Spesifikasi" HeaderText="Specification" SortExpression="Spesifikasi" />
                            <asp:BoundField DataField="Jumlah_Stock" HeaderText="Stock Quantity" SortExpression="Jumlah_Stock" />
                            <asp:BoundField DataField="Unit" HeaderText="Unit" SortExpression="Unit" />
                            <asp:BoundField DataField="Isyarat_Stok" HeaderText="Stock Signal" SortExpression="Isyarat_Stok" />
                            <asp:BoundField DataField="Stok_Minima" HeaderText="Minimum Stock" SortExpression="Stok_Minima" />

                            <asp:CheckBoxField DataField="IsInvestor" HeaderText="IsInvestor" Visible="false" />
                            <asp:CheckBoxField DataField="IsVisitor" HeaderText="IsVisitor" Visible="false" />
                            <asp:CheckBoxField DataField="IsStudent" HeaderText="IsStudent" Visible="false" />
                            <asp:CheckBoxField DataField="IsStaffRetired" HeaderText="IsStaffRetired" Visible="false" />
                            <asp:CheckBoxField DataField="IsStaffNoticed" HeaderText="IsStaffNoticed" Visible="false" />
                            <asp:CheckBoxField DataField="IsVIP" HeaderText="IsVIP" Visible="false" />
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eSouvenirConnectionString %>" SelectCommand="SELECT * FROM [Sou_StockItem]"></asp:SqlDataSource>
                </div>
            </form>
        </div>
    </div>
