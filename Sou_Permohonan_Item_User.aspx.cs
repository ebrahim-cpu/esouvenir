...
namespace eSouvenir
{
    public partial class Sou_Permohonan_Item_User : System.Web.UI.Page
    {
        ...
        protected void BtnHantar_Click(object sender, EventArgs e)
        {
            ...
            // EMAIL SECTION START ----------------------
            string str0 = "Salam, <br /><br />Berikut adalah maklumat tempahan souvenir: <br /><br /> ";
            ...
            string str10 = "Terima Kasih. <br /><br /> Sistem eSouvenir Admin.";
            string badanEmail = str0 + str1 + str2 + str3 + str4 + str5 + str6 + str7 + str8 + str9 + str10;
            string emailSubjek = "Sistem eSouvenir, Permohonan souvenir: " + pemohon + " " + requestDate;
            string emailGeng = Session["email"].ToString() + "; zarina@khtp.com.my; ibrahim@khtp.com.my;";
            try
            {
                ...
                mail.CC.Add(new MailAddress("norsakeena.arshad@khtp.com.my"));
