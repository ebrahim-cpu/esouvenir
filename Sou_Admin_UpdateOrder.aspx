<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Admin_UpdateOrder.aspx.cs" Inherits="eSouvenir.Sou_Admin_UpdateOrder" %>
...
<body>
    <%--sidebar editor--%>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display: none; background-color: #a90505; color: #fff; width: 250px; background-image: url('/Images_Black/aiart5836_dark_classic_landscape_art.png'); background-size: cover; background-repeat: repeat;" id="mySidebar">
        ...
        <div class="w3-container">
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="txtOrderId" style="font-size: 18px;"><b><span style="color: deepskyblue;" />1. Order Id </b></label>
                                <asp:TextBox ID="txtOrderId" CssClass="form-control" Width="438px" runat="server" ReadOnly="true"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="txtTarikhPermohonan" associatedcontrolid="txtTarikhPermohonan" style="font-size: 18px;"><b><span style="color: deepskyblue;" />2. Order Date</b> </label>
                                <asp:TextBox ID="txtTarikhPermohonan" type="date" runat="server" CssClass="form-control" TextMode="Date" Width="442px"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="txtNamaPengguna" style="font-size: 18px;"><b><span style="color: deepskyblue;" />3. Requestor</b></label>
                                <br />
                                <asp:TextBox ID="txtNamaPengguna" CssClass="form-control" Width="438px" ReadOnly="true" runat="server"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="txtKategori" style="font-size: 18px;"><b><span style="color: deepskyblue;" />4. Item Category</b> </label>
                                <div class="auto-style4">
                                    <asp:TextBox ID="txtKategori" runat="server" CssClass="form-control " Width="438px" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="txtNamaItem" style="font-size: 18px;"><b><span style="color: deepskyblue;" />5. Item</b> </label>
                                <div class="auto-style4">
                                    <asp:TextBox ID="txtNamaItem" runat="server" CssClass="form-control " Width="438px" Height="40px" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="txtKuantiti" style="font-size: 18px;"><b><span style="color: deepskyblue;" />6. Quantity Item( Available Stock )</b> </label>
                                <asp:TextBox ID="txtKuantiti" CssClass="form-control" Width="438px" ReadOnly="true" runat="server"></asp:TextBox>
                            </div>
                            <label style="font-size: 14px;"><span style="color: floralwhite" />Latest stock figure from database + Previous Order Qty. It may differ from the current Order record. </label>
                            <br />
                            <div class="form-group">
                                <label for="txtBilKuantitiYgDimahukan" style="font-size: 18px;"><b><span style="color: deepskyblue;" />7. Quantity Request</b> </label>
                            ...
                            <br />
                            <div class="form-group">
                                <label for="txtDescription" style="font-size: 18px;"><b><span style="color: deepskyblue;" />8. Remarks</b></label>
                                <asp:TextBox ID="txtDescription" TextMode="MultiLine" Rows="3" CssClass="form-control" runat="server" Width="438px"></asp:TextBox>
                                &nbsp; &nbsp;                       
                            </div>
                            <br />
                            <div class="text-left">
                                <asp:TextBox ID="txtPreviousOrderQuantity" runat="server" Visible="false"></asp:TextBox>
                                <!-- To store previous Order Qty -->
                                <asp:TextBox ID="txtItemId" runat="server" Visible="false"></asp:TextBox>
                                <asp:Button ID="AcceptButton" runat="server" Text="Accept" OnClick="AcceptButton_Click" CssClass="btn btn-primary" Height="38px" Width="120px" />
                                <asp:Button ID="RejectButton" runat="server" Text="Reject" OnClick="RejectButton_Click" OnClientClick="return confirm('Are you sure you want to reject?');" CssClass="btn btn-danger" Height="38px" Width="120px" />
                                <asp:Button ID="AdjustButton" runat="server" Text="Adjust" OnClick="AdjustButton_Click" CssClass="btn btn-warning" Height="38px" Width="120px" />
                                <br />
                                <asp:Label ID="lblErrorMessage" runat="server" Style="color: red;" Visible="false"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <p>&copy; <%: DateTime.Now.Year %> - KTPC Sdn. Bhd. eStationary v1.0 | Last Update: 27 February 2024</p>
                </div>
            </form>
            <%-- End content --%>
        </div>
