<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Senarai_Item_User6.aspx.cs" Inherits="eSouvenir.Sou_Senarai_Item_User6" %>
            ...
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eSouvenirConnectionString %>" SelectCommand="SELECT [Id_Item], [Nama_Item], [Id_Kategori], [Kategori], [Spesifikasi], [Unit], [Stok_Minima], [Jumlah_Stock], [Isyarat_Stok] FROM [Sou_StockItem]"></asp:SqlDataSource>
                    </div>
                </div>
                <hr />
