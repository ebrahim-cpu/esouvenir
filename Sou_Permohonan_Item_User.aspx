<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Permohonan_Item_User.aspx.cs" Inherits="eSouvenir.Sou_Permohonan_Item_User" %>
...
<head runat="server">
    ...
    <style>
        body {
            background-image: url('Images_Black/28895.jpg');
    ...
    <script>   /* script sidebar */
        ...
        function validateForm() {
            ...
            var txtBilKuantitiYgDimahukan = document.getElementById("txtBilKuantitiYgDimahukan").value;
            ...
            if (txtBilKuantitiYgDimahukan.trim() == "") {
...
<body>
    <%--sidebar editor--%>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display: none; background-color: #a90505; color: #fff; width: 250px; background-image: url('/Images_Black/Default_A_wall_paper_consist_of_collages_of_stationary_items_3(1).jpg'); background-size: cover; background-repeat: no-repeat;" id="mySidebar">
            ...
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="chkListOptions" style="font-size: 18px;"><b><span style="color: deepskyblue;" /></b></label>
                                <asp:CheckBoxList ID="chkListOptions" runat="server" CssClass="form-control" AutoPostBack="true" Width="438px" ReadOnly="true" Visible="false">
                            ...
                            <div class="form-group">
                                <label for="txtTarikhPermohonan" associatedcontrolid="txtTarikhPermohonan" style="font-size: 18px;"><b><span style="color: deepskyblue;" />1. Date Request</b> </label>
                            ...
                            <div class="form-group">
                                <label for="txtNamaPengguna" style="font-size: 18px;"><b><span style="color: deepskyblue;" />2. Requester </b></label>
                                <br />
                            ...
                            <div class="form-group">
                                ...
                                <div class="auto-style4">
                                    <asp:DropDownList ID="ddlKategori" runat="server"  CssClass="form-control " Width="438px" AutoPostBack="true" Enabled="false"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group" style="display: none;">
                                <label for="txtIdKategori" style="font-size: 18px;"><b><span style="color: deepskyblue;" />Not Visible. Id Kategori</b>  </label>
                                <asp:TextBox ID="txtIdKategori" runat="server" CssClass="form-control " ReadOnly="true" AutoPostBack="true" Width="438px"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="DropDownList2" style="font-size: 18px;"><b><span style="color: deepskyblue;" />4. Items</b> </label>
                                <div class="auto-style4">
                                    <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="form-control " Width="438px" AutoPostBack="true" Height="40px" Enabled="false"></asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group" style="display: none;">
                                <label for="txtIdItem" style="font-size: 18px;"><b><span style="color: deepskyblue;" />Not Visible. Id Item</b> </label>
                                <asp:TextBox ID="txtIdItem" CssClass="form-control" runat="server" Width="438px"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="lblUnit" style="font-size: 18px;"><b><span style="color: deepskyblue;" />6. Items Unit Measurement</b> </label>
                                <asp:TextBox ID="txtUnit" CssClass="form-control" ReadOnly="true" runat="server" Width="438px"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="txtKuantiti" style="font-size: 18px;"><b><span style="color: deepskyblue;" />7. Items Available Stock</b> </label>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDescription" TextMode="MultiLine" Rows="3" CssClass="form-control" runat="server" Width="438px" placeholder="Please fill in remarks"></asp:TextBox>
                                &nbsp; &nbsp;                       
                            </div>
                            <br />
                    ...
                    <div class="text-center">
                        <asp:Button ID="btnHantar" runat="server" Text="Send" OnClientClick="return validateForm();" OnClick="BtnHantar_Click" CssClass="btn btn-primary " Height="38px" Width="170px" />
                        <br />
                        <asp:Label ID="lblErrorMesage" runat="server" Style="color: red;" Visible="false"></asp:Label>
                    </div>
                </div>
                <br />
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <p>&copy; <%: DateTime.Now.Year %> - KTPC Sdn. Bhd. eStationary v1.0 | Last Update: 25 February 2023</p>
                </div>
            </form>
            <%-- End content --%>
        </div>
