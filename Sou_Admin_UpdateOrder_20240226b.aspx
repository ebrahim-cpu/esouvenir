<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Admin_UpdateOrder_20240226b.aspx.cs" Inherits="eSouvenir.Sou_Admin_UpdateOrder" %>
        ...
        <div class="w3-container">
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="txtNamaPengguna" style="font-size: 18px;"><b><span style="color: deepskyblue;" />3. Order Person </b></label>
                                <br />
                                <asp:TextBox ID="txtNamaPengguna" CssClass="form-control" Width="438px" ReadOnly="true" runat="server"></asp:TextBox>
                            </div>
                            <br />
                            <div class="form-group">
                                <label for="txtKategori" style="font-size: 18px;"><b><span style="color: deepskyblue;" />4. Category</b> </label>
                            ...
                            <br />
                            <div class="form-group">
                                <label for="txtKuantiti" style="font-size: 18px;"><b><span style="color: deepskyblue;" />6. Quantity ( Available Stock )</b> </label>
                    ...
                    <div class="text-center">
                        ...
                        <asp:TextBox ID="txtPreviousOrderQuantity" runat="server" Visible="false"></asp:TextBox> <!-- To store previous Order Qty -->
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <p>&copy; <%: DateTime.Now.Year %> - KTPC Sdn. Bhd. eStationary v1.0 | Last Update: 20 February 2024</p>
                </div>
            </form>
            <%-- End content --%>
        </div>
