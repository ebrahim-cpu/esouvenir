<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Admin_Pendaftaran_Item_20240229.aspx.cs" Inherits="eSouvenir.Sou_Admin_Pendaftaran_Item" %>
            ...
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group">
                            <label for="txtIdKategori"><b><span style="color: deepskyblue;" />3. Id Category </b></label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="txtItemBaru"><b><span style="color: deepskyblue;" />4. Item</b>  </label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="txtSpesifikasi"><b><span style="color: deepskyblue;" />5. Specification</b> </label>
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="txtJumlahStock"><b><span style="color: deepskyblue;" />6. Quantity</b> </label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="txtUnit"><b><span style="color: deepskyblue;" />7. Unit</b>  </label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="txtStokMinima"><b><span style="color: deepskyblue;" />8. Min Stock</b>  </label>
                        ...
                        <br />
                            <div class="form-group">
                                <label for="txtStokMinima"><b><span style="color: deepskyblue;" />9. Package</b>  </label>
