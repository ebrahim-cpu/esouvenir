<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Kelulusan_Souvenir_20240226.aspx.cs" Inherits="eSouvenir.Sou_Kelulusan_Souvenir" %>
...
<body>
    <%--sidebar editor--%>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display: none; background-color: #a90505; color: #fff; width: 250px; background-image: url('/Images_Black/Default_Celestial.jpg'); background-size: cover; background-repeat: no-repeat;" id="mySidebar">
        ...
        <div class="w3-container">
            <form id="form1" runat="server" method="post" enctype="multipart/form-data">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                           <asp:Button ID="UpdateButton" runat="server" Text="Adjustment" CssClass="btn btn-warning" OnClientClick="return false;" />
                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-3d table-striped table-bordered" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" CellPadding="3" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" BackColor="White" BorderColor="#999999" BorderWidth="1px" GridLines="Vertical" PageSize="300" BorderStyle="None" OnRowCommand="GridView1_RowCommand">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Id_Pengguna" HeaderText="User Id" SortExpression="Id_Pengguna" />
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <div class="btn-container">
                                                <asp:Button ID="AcceptButton" runat="server" Text="Accept" CssClass="btn btn-primary btn-sm"
                                                    CommandName="AcceptCommand" CommandArgument='<%# Eval("Id") %>' OnClick="AcceptButton_Click"
                                                    Visible='<%# ShowAcceptButton(Eval("Status")) %>' />
                                                <asp:Button ID="RejectButton" runat="server" Text="Reject" CssClass="btn btn-danger btn-sm"
                                                    CommandName="RejectCommand" CommandArgument='<%# Eval("Id") %>' OnClick="RejectButton_Click"
                                                    Visible='<%# ShowRejectButton(Eval("Status")) %>' />
                                                <asp:Button ID="UpdateButton" runat="server" Text="Adjust" CssClass="btn btn-warning btn-sm"
