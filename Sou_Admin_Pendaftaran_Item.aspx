<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Admin_Pendaftaran_Item.aspx.cs" Inherits="eSouvenir.Sou_Admin_Pendaftaran_Item" %>
...
<body>
    <%--sidebar editor--%>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display: none; background-color: #a90505; color: #fff; width: 250px; background-image: url('./Images_Black/magdamm_text_ENVY.png'); background-size: cover; background-repeat: repeat;" id="mySidebar">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="form-group">
                            <label for="txtTarikh" associatedcontrolid="txtTarikhItem"><b><span style="color: deepskyblue;" />1. Date</b></label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="ddlKategori"><b><span style="color: deepskyblue;" />2. Category</b> </label>
                            <div class="a">
                        ...
                        <div class="form-group">
                            <label for="txtItemBaru"><b><span style="color: deepskyblue;" />3. Item</b>  </label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="txtSpesifikasi"><b><span style="color: deepskyblue;" />4. Specification</b> </label>
                    ...
                    <div class="col-5">                   
                        ...
                        <div class="form-group">
                            <label for="txtUnit"><b><span style="color: deepskyblue;" />5. Unit</b>  </label>
                        ...
                        <br />
                        <div class="form-group">
                            <label for="txtStokMinima"><b><span style="color: deepskyblue;" />6. Min Stock</b>  </label>
                        ...
                        <br />
                            <div class="form-group">
                                <label for="txtStokMinima"><b><span style="color: deepskyblue;" />7. Package</b>  </label>
                        ...
                        <asp:TextBox ID="txtIdKategori" runat="server" CssClass="form-control " visible="false" Width="400px" ReadOnly="true" Style="border-color: black; border-width: 1px;"></asp:TextBox>
                        <asp:TextBox ID="txtJumlahStock" CssClass="form-control" Width="400px" visible="false" placeholder="Please insert the amount" runat="server"  Style="border-color: black; border-width: 1px;"></asp:TextBox>
                    </div>
                </div>
                <br />
                <hr class="rounded" />
...
<%-- <asp:Button ID="btnCustomize" runat="server" CssClass="btn btn-primary" Text="Edit" OnClick="BtnCustomize_Click" CommandArgument='<%# Eval("Id_Kategori") + "," + Eval("Kategori") + "," + Eval("Id_Item") + "," + Eval("Nama_Item") + "," + Eval("Spesifikasi") + "," + Eval("Unit") + "," + Eval("Jumlah_Stock") + "," + Eval("Stok_Minima") %>' />--%>
                                    <asp:Button ID="btnCustomize" runat="server" CssClass="btn btn-primary" Text="Edit" OnClick="BtnCustomize_Click" CommandArgument='<%# Eval("Id_Item") %>' />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eSouvenirConnectionString%>"
                    SelectCommand="SELECT [Id_Item], [Guid], [Kategori], [Nama_Item], [Spesifikasi], [Jumlah_Stock], [Unit], [Isyarat_Stok], [Stok_Minima], [Tarikh_Pendaftaran_Item], [ModifiedDate], [Id_Kategori] FROM [Sou_StockItem] ORDER BY [Id_Item] DESC"
