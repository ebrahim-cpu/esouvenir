<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sou_Senarai_Item_User_checkBoxVisible_20240213.aspx.cs" Inherits="eSouvenir.Sou_Senarai_Item_User" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="Id_Item,Id_Kategori" DataSourceID="SqlDataSource2" AllowPaging="True" CssClass="table table-3d table-striped table-bordered" AllowSorting="True" PageSize="300" OnRowCommand="GridView2_RowCommand" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="IsInvestor">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsInvestor" runat="server" Checked='<%# Eval("IsInvestor") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IsVisitor">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsVisitor" runat="server" Checked='<%# Eval("IsVisitor") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IsStudent">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsStudent" runat="server" Checked='<%# Eval("IsStudent") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IsStaffRetired">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsStaffRetired" runat="server" Checked='<%# Eval("IsStaffRetired") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IsStaffNoticed">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsStaffNoticed" runat="server" Checked='<%# Eval("IsStaffNoticed") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="IsVIP">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsVIP" runat="server" Checked='<%# Eval("IsVIP") %>' Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:eSouvenirConnectionString %>" SelectCommand="SELECT * FROM [Sou_StockItem]"></asp:SqlDataSource>
                    </div>
                </div>
                <hr />
